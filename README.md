potatolang (pol) is a Lua dialect written in golang. It adapts most features in Lua 5.x with some extra enhancements. Its VM design is a whole different system and bytecode is not compatible
